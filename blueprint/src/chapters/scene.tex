\subsection{Ket-bra operators}
 ...
 \begin{lemma}\uses{rankOne}\label{linear_map_comp_rank_one}\lean{ContinuousLinearMap.comp_rankOne}\leanok\label{rank_one_comp_linear_map}\lean{ContinuousLinearMap.rankOne_comp}\leanok\label{rank_one.adjoint}\lean{rankOne_adjoint}\leanok
